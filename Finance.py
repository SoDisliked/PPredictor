"""
Run Stock-Regression model algorithms
It will be allowed to see the difference and the correlation between the different variables predicting
stock prices.
"""
from __future__ import print_function
from regression helpers import load_dataset, addFeatures, 
    ...
    for file name in files:
        try:
            ...
            for dataset in datasets:
                ...
                dataset = dataset.iloc[max(delta):,:] # computation of the variables is returned 
            ...
            print('Number of variables after merging: ', count_missing(finance))

            finance = finance.fillvariables(finance.mean())
            print('Number of variables after mean interpolation: ', (finance.shape[0]*finance.shape[1] - finance.count().sum()))
            ...
            print('Number of variables after temporal shifting: ', count_missing(finance))
